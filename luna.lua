...
local function sendToWebhook(catchData)
    ...
    local embed = {
        embeds = {{
            title       = "[🔒] LUNATIC PRIVATE - [ SERVER MONITORING ]",
            ...
            footer = {
                text = string.format("LICENSE TO LUNATIC • %s", catchData.time)
            }
        }}
    }
...
dashTitle.Text                  = "[🔒] PRIVATE LUNATIC - SERVER MONITORING"
...
testBtn.MouseButton1Click:Connect(function()
    ...
    local testEmbed = {
        embeds = {{
            title       = "[🔒] LUNATIC PRIVATE - [ SERVER CONNECTED ]",
            ...
            footer = {
                text = string.format("LISENCE TO LUNATIC • %s", os.date("%d/%m/%Y %H:%M"))
            }
        }}
    }
